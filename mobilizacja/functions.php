...
function mobilizacja_scripts() {
	wp_enqueue_style( 'main', get_stylesheet_directory_uri() . '/main.css', array(), _S_VERSION );
	wp_enqueue_style( 'fontawesome-style', 'https://fonts.googleapis.com/css2?family=Cardo:ital,wght@0,400;0,700;1,400&family=Mulish:wght@200;300;400;500;600;700;800&display=swap' );
	...
	wp_enqueue_script( 'webpack', get_stylesheet_directory_uri() . '/assets/scripts.js', array( 'jquery' ), null, true );
